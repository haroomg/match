...
#2 se puede modificar para que no sea un df sino solo un object
def assign_reference_to_image(object: list = None, list_images_name: str = None, ref_name: str = None) -> dict:
    
    img_with_ref: dict = {}
    
    for obj in object:
        
        ref: any = obj[ref_name]
        imges_list: list = obj[list_images_name]
        
        for img_name in imges_list:
            
            img_with_ref[img_name] = ref
